...
public class bill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        endprice.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                endpriceFocusGained(evt);
            }
        });
        ...
        balancebox.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                balanceboxFocusGained(evt);
            }
        });
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {            
            String fd = "Select fid from food where fname = '"+ iname + "'";
            sss = sos.prepareStatement(fd);
            rs = sss.executeQuery();
            
            while (rs.next()) {
            foodId = rs.getInt("fid");
                String qr= "INSERT INTO `sale`(`quantity`, `item_price`, `amount`,`fid`) VALUES ('"+iquantity+"','"+iprice+"','"+iamount+"',"+rs.getInt("fid")+")";
       ...
       String date = sdf.format(datebox.getDate());
        ...
        try 
        {
            ...
            String sen = "INSERT INTO allsale (stype ,sprice,squantity,sendprice,stotalamou,scashs,sbalances,date,fid) VALUES ('"+type+"','"+price+"','"+quantitys+"','"+endprices+"','"+totalamount+"','"+cashs+"','"+balances+"','"+date+"','"+foodId+"')";
    ...
    private void endpriceFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_endpriceFocusGained
        int price = Integer.parseInt(pricebox.getText());
        int quan = Integer.parseInt(jComboBox1.getSelectedItem().toString());
        int end = price * quan;
        endprice.setText(String.valueOf(end));
        totalamountbox.setText(String.valueOf((end)));        
    }//GEN-LAST:event_endpriceFocusGained

    private void balanceboxFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_balanceboxFocusGained
            int cash = Integer.parseInt(cashbox.getText());
            int total = Integer.parseInt(totalamountbox.getText());
            int finale = total - cash ;
            balancebox.setText(String.valueOf((finale)));
    
    }//GEN-LAST:event_balanceboxFocusGained
      ...
      int result = NO_SUCH_PAGE;    
        ...
        try{
           ...
           // int headerRectHeighta=40;
            ...
            g2d.drawString("        Restaurant       ",12,y);y+=yShift;
            g2d.drawString("   Kathmandu ",12,y);y+=yShift;
            g2d.drawString("           NEpal",12,y);y+=yShift;
            g2d.drawString("   Restaurant Bill ",12,y);y+=yShift;
            g2d.drawString("        Phone Ni. -------      ",12,y);y+=yShift;
            ...
            g2d.drawString("*************************************",10,y);y+=yShift;
           g2d.drawString("   CONTACT:                           ",10,y);y+=yShift;       
